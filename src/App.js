...
const TREE = {
  ...
  children:[
    ...
    // ПРАВИТЕЛЬСТВО
    // ══════════════════════════════════════════
    {id:"pm", name:"Бектенов Олжас Абенович", title:"Премьер-Министр РК", since:"2024", birthday:"26.05.1981", level:1, org:"Правительство РК",
     ...
     children:[
      ...
      {id:"vpm6", name:"Балаева Аида Галымовна", title:"Зам. Премьер-Министра – Министр культуры и информации", since:"2023", birthday:"04.07.1974", female:true, level:2, org:"МКИ",
       ...
       children:[
         ...
         // МТС
         {id:"tsm", name:"Мырзабосынов Ербол Куантаевич", title:"Министр туризма и спорта РК", since:"2025", birthday:"1984", level:3, org:"Министерство туризма и спорта",
      ...
      // ── МЧС
      {id:"emer", name:"Аринов Чингис Сайранулы", title:"Министр по чрезвычайным ситуациям РК", since:"2024", birthday:"1983", level:2, org:"МЧС",
